...
class Controller {
	...
	public function save(){
		...
		$sql = "replace into t_identitas values (null, '$nip','$nama','$jenis_kelamin','$tempat_lahir','$tanggal_lahir',
			'$kd_agama','$kd_pangkat','$pangkat_tmt','$kd_jabatan','$jabatan_tmt','$masa_kerjakes', null, null)";
		$response->test = $sql;
