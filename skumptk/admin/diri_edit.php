...
<div class="container">
	<div class="row">
		...
		<div class="col-md-9">
			...
			$nip = $_POST['nip'];
			$link = koneksi_db();
			$sql="SELECT * FROM t_identitas WHERE nip='$nip'";
			$res= mysql_query($sql);
			if (mysql_num_rows($res)==1) {
			 	$data = mysql_fetch_array($res);?>
			 	<form method="post" action="diri_proses_update.php">
			 		<div>
						<h3 class="text-center">
						EDIT DATA DIRI PEGAWAI
						</h3>
					</div>
					<br>
					<br>
					...
					<div class="container">
						...
						<div class="form-group">
	                      <label for="nama" class="col-md-3 control-label text-right">Nama</label>
	                      <div class="col-md-5">
	                        <input type="text" class="form-control" id="nama" name="nama" value="<?=$data['nama']?>" size=31 maxlength=30>
	                      </div>
	                      <br><br>
	                    </div>
	                    <div class="form-group">
	                      <label for="nama" class="col-md-3 control-label text-right">Tempat Lahir</label>
	                      <div class="col-md-5">
	                        <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" value="<?=$data['tempat_lahir']?>" size=31 maxlength=30>
	                      </div>
	                      <br><br>
	                    </div>
	                    <!--<div class="form-group">
